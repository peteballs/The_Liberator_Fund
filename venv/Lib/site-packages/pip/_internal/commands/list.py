...
class ListCommand(IndexGroupCommand):
    ...
    def run(self, options, args):
        ...
        self.output_package_result(packages, options)
    ...
    def output_package_result(self, packages, options):
        packages = sorted(
            packages,
        ...
        if options.list_format == 'columns' and packages:
            ...
            self.output_package_result_columns(data, header)
    ...
    def output_package_result_columns(self, data, header):
...
def format_for_columns(pkgs, options):
    ...
    by output_package_result_columns.
    """
